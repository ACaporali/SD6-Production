//Initialise le loadervar loader = '<div class="loader">'+
var loader = '<p>Bonjour je charge</p>'/*'<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org" id="camera-loader" width="85.708488" height="100">'+
	'<defs id="defs12" />'+
