$( document ).ready(function(){
	...
	$(document).on('click','.galerie .photos ul li a img', function(e) {
		e.preventDefault();
		var imageSrc = $(this).attr("src");
		$('.galerie .photos ul li').removeClass("show");
		$(this).closest('.galerie .photos ul li').addClass("show");
	...
	function boucleVisionneuse(sens) {
		...
		if (sens == "prev") {
			var PrecSuivli = $('.galerie .photos ul li.show').prev('li');
		}else{
			var PrecSuivli = $('.galerie .photos ul li.show').next('li');
		}
		...
		if (imgSrc != null) {
			...
			if (sens == "prev") {
				var premierDernierLi = $('.galerie .photos ul li').last();
			}else{
				var premierDernierLi = $('.galerie .photos ul li').first();
			}
